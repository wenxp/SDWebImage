...
- (void)sd_setBackgroundImageWithURL_setContentmode:(NSURL *)url forState:(UIControlState)state placeholderImage:(UIImage *)placeholder completed:(SDWebImageCompletionBlock)completedBlock {
    [self sd_setBackgroundImageWithURL_setContentmode:url forState:state placeholderImage:placeholder options:0 completed:completedBlock];
}
...
- (void)sd_setBackgroundImageWithURL_setContentmode:(NSURL *)url forState:(UIControlState)state placeholderImage:(UIImage *)placeholder options:(SDWebImageOptions)options completed:(SDWebImageCompletionBlock)completedBlock {
    [self sd_cancelImageLoadForState:state];
